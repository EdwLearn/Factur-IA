  ...
  const pricing = [
    {
      ...
      description: "Solo para los primeros 15 clientes",
      features: [
        "Facturas ilimitadas",
      ...
      popular: true,
      badge: "Ahorra $180,000/mes",
      savings: "$2,160,000 COP/año",
    },
    {
      name: "Básico",
      price: "$465,000",
      period: "/mes",
      description: "Plan estándar completo",
      features: [
        "Facturas ilimitadas",
        "ML pricing inteligente",
        "Todas las integraciones POS",
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm">
                  ...
                  <span className="text-sm font-medium">1 hora → 2 min por factura</span>
                </div>
                <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Únete a los negocios minoristas colombianos que ya automatizaron sus procesos
            </p>
          </div>
      ...
      <section id="precios" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Inversión inteligente para automatizar tu operación</p>
          </div>
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <Badge className="bg-blue-600 text-white hover:bg-blue-600">{plan.badge || "Más Popular"}</Badge>
                  </div>
                )}
                {!plan.popular && plan.badge && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <Badge className="bg-orange-500 text-white hover:bg-orange-500">{plan.badge}</Badge>
                  </div>
                )}
                <CardContent className="p-8">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Únete a los negocios minoristas colombianos que ya transformaron su operación
          </p>
